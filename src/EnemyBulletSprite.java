...
public class EnemyBulletSprite extends Sprite {
	...
	public EnemyBulletSprite(double currentX, double currentY, double velocityX, double velocityY, String enemy) {
		...
		if (enemy.equals("baron")) {
			try {
				if (defaultImage == null) {
					defaultImage = ImageIO.read(new File("res/baronSpit.png"));
				}
			...
			try {
				if (defaultImage == null) {
					defaultImage = ImageIO.read(new File("res/enemyBullet.png"));
				}
